...
class orignalVerbSarfKabeerAdapter(
    private var sarfSagheer: ArrayList<ArrayList<*>>,
    private val context: Context
                                  ) :
    RecyclerView.Adapter<orignalVerbSarfKabeerAdapter.ViewHolder>() {
    ...
    private fun AmarNahi(holder: ViewHolder, position: Int) {
        ...
        if (isTraditional) {
            ...
            sb.append("-")
            sb.append(sarfSagheer[position][0].toString())
            anta = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[7])
            sb.append("-")
            sb.append(sarfSagheer[position][2].toString())
            antuma = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[8])
            sb.append("-")
            sb.append(sarfSagheer[position][3].toString())
            antum = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[9])
            sb.append("-")
            sb.append(sarfSagheer[position][1].toString())
            anti = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[7])
            sb.append("-")
            ...
            sb.append("-")
            sb.append(sarfSagheer[position][4].toString())
            antunna = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[11])
            sb.append("-")
        } else {
            anta = sarfSagheer[position][0].toString()
            antuma = sarfSagheer[position][2].toString()
            antum = sarfSagheer[position][3].toString()
            anti = sarfSagheer[position][1].toString()
    ...
    private fun Amar(holder: ViewHolder, position: Int) {
        val anta: String
        val antuma: String
        val antum: String
        val anti: String
    ...
    private fun MudhariMajhool(holder: ViewHolder, position: Int) {
        val hua: String
        val huma: String
        val hum: String
        val hia: String
        ...
        if (isTraditional) {
            ...
            sb.append("-")
            sb.append(sarfSagheer[position][5].toString())
            hunna = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[6])
            sb.append("-")
            sb.append(sarfSagheer[position][6].toString())
            anta = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[7])
            sb.append("-")
            sb.append(sarfSagheer[position][7].toString())
            antuma = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[8])
            sb.append("-")
            sb.append(sarfSagheer[position][8].toString())
            antum = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[9])
            sb.append("-")
            sb.append(sarfSagheer[position][9].toString())
            anti = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[7])
            sb.append("-")
            ...
            sb.append(arraypronouns[11])
            sb.append("-")
            sb.append(sarfSagheer[position][10].toString())
            antunna = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[12])
            sb.append("-")
            sb.append(sarfSagheer[position][11].toString())
            ana = sb.toString()
            sb = StringBuilder()
            sb.append(arraypronouns[13])
            sb.append("-")
            sb.append(sarfSagheer[position][12].toString())
            nahnu = sb.toString()
        } else {
            hua = sarfSagheer[position][0].toString()
            huma = sarfSagheer[position][1].toString()
            hum = sarfSagheer[position][2].toString()
            hia = sarfSagheer[position][3].toString()
            humaf = sarfSagheer[position][4].toString()
            hunna = sarfSagheer[position][5].toString()
            anta = sarfSagheer[position][6].toString()
            antuma = sarfSagheer[position][7].toString()
            antum = sarfSagheer[position][8].toString()
            anti = sarfSagheer[position][9].toString()
            antumaf = sarfSagheer[position][4].toString()
            antunna = sarfSagheer[position][10].toString()
...
//ismfaile
    ...
    private fun MadhiMajhool(holder: ViewHolder, position: Int) {
        val hua: String
        val huma: String
        val hum: String
        val hia: String
    ...
    private fun MudhariMaroof(holder: ViewHolder, position: Int) {
        val hua: String
        val huma: String
        val hum: String
        val hia: String
    ...
    private fun MadhiMaroof(holder: ViewHolder, position: Int) {
        val hua: String
        val huma: String
        val hum: String
        val hia: String
        ...
        if (isTraditional) {
            ...
            antum = sarfSagheer[position][8].toString()
            anti = sarfSagheer[position][9].toString()
            antumaf = sarfSagheer[position][7].toString()
            antunna = sarfSagheer[position][10].toString()
            ana = sarfSagheer[position][11].toString()
            nahnu = sarfSagheer[position][12].toString()
        }
