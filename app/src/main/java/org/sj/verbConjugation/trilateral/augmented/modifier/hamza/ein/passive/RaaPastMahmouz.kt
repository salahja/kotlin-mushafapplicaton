...
class RaaPastMahmouz : SubstitutionsApplier(), IAugmentedTrilateralModifier {
    override val substitutions: MutableList<InfixSubstitution> = ArrayList()

    init {
        substitutions.add(InfixSubstitution("ْءِ", "ِ")) // EX: (أُرِيتُ، أُرِيَ)
        substitutions.add(InfixSubstitution("ْءُ", "ُ")) // EX: (أُرُوا، )
    }
