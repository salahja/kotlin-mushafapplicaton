...
class AugmentedPresentVerb9(
    ...
    override fun form(): String {
        ...
        return cp + ArabCharUtil.DAMMA + "س" + ArabCharUtil.SKOON + "ت" + ArabCharUtil.FATHA + root!!.c1 + ArabCharUtil.SKOON + root!!.c2 + ArabCharUtil.FATHA + root!!.c3 + lastDpr + connectedPronoun
    }
}