...
class AugmentedPresentVerb8(
    ...
    override fun form(): String {
        ...
        return cp + ArabCharUtil.DAMMA + "ت" + ArabCharUtil.FATHA + root!!.c1 + ArabCharUtil.FATHA + root!!.c2 + ArabCharUtil.SHADDA + ArabCharUtil.FATHA + root!!.c3 + lastDpr + connectedPronoun
    }
}