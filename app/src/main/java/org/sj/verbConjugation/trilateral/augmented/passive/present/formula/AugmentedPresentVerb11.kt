...
class AugmentedPresentVerb11(
    ...
    override fun form(): String {
        ...
        return cp + ArabCharUtil.DAMMA + root!!.c1 + ArabCharUtil.SKOON + root!!.c2 + ArabCharUtil.FATHA + "و" + ArabCharUtil.SHADDA + ArabCharUtil.FATHA + root!!.c3 + lastDpr + connectedPronoun
    }
}