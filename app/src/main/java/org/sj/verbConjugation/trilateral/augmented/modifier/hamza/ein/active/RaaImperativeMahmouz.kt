...
class RaaImperativeMahmouz : SubstitutionsApplier(), IAugmentedTrilateralModifier {
    override val substitutions: MutableList<InfixSubstitution> = ArrayList()

    init {
        substitutions.add(InfixSubstitution("ْءِ", "ِ")) // EX: (أَرِ، )
        substitutions.add(InfixSubstitution("ْءُ", "ُ")) // EX: (أَرُوا، )
    }
