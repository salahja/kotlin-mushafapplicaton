 ...
 * @version 1.0
 */
class NounFormula7 : NonStandardInstrumentalNounFormula {
    ...
    override fun form(): String {
        when (suffixNo) {
            2, 4, 8, 10, 14, 16 -> return root.c1.toString() + ArabCharUtil.DAMMA + root.c2 + ArabCharUtil.SKOON + root.c3 + suffix
        }
        return ""
    }
