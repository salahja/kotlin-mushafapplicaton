 ...
 * @version 1.0
 */
class NounFormula4 : NonStandardInstrumentalNounFormula {
    ...
    override fun form(): String {
        when (suffixNo) {
            1, 3, 7, 9, 13, 15 -> return root.c1.toString() + ArabCharUtil.FATHA + root.c2 + ArabCharUtil.SHADDA + ArabCharUtil.FATHA + ArabCharUtil.Aleph + root.c3 + suffix
        }
        return ""
    }
