...
class NounFormula6 : NonStandardExaggerationNounFormula {
    ...
    override fun form(): String {
        when (suffixNo) {
            1, 7, 13 -> return root.c1.toString() + ArabCharUtil.FATHA + root.c2 + ArabCharUtil.SHADDA + ArabCharUtil.FATHA + ArabCharUtil.Aleph + root.c3 + ArabCharUtil.FATHA + "ة" + suffix
        }
        return ""
    }
