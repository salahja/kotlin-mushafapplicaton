 ...
 * @version 1.0
 */
class NounFormula11(root:AugmentedTrilateralRoot, suffix: String?) :
    ...
    override fun form(): String {
        return ArabCharUtil.MEEM + ArabCharUtil.DAMMA + root!!.c1 + ArabCharUtil.SKOON + root!!.c2 + ArabCharUtil.FATHA + ArabCharUtil.WAW + ArabCharUtil.SHADDA + ArabCharUtil.FATHA + root!!.c3 + suffix
    }
}