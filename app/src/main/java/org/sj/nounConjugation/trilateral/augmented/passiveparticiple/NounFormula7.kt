 ...
 * @version 1.0
 */
class NounFormula7(root:AugmentedTrilateralRoot, suffix: String?) :
    ...
    override fun form(): String {
        return ArabCharUtil.MEEM + ArabCharUtil.DAMMA + ArabCharUtil.TA + ArabCharUtil.FATHA + root!!.c1 + ArabCharUtil.FATHA + ArabCharUtil.Aleph + root!!.c2 + ArabCharUtil.FATHA + root!!.c3 + suffix
    }
}