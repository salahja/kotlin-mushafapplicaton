...
class NounFormula10(root: AugmentedTrilateralRoot, suffix: String?) :
    ...
    override fun form(): String {
        return ArabCharUtil.MEEM + ArabCharUtil.DAMMA + root!!.c1 + ArabCharUtil.SKOON + root!!.c2 + ArabCharUtil.FATHA + ArabCharUtil.WAW + ArabCharUtil.SKOON + root!!.c2 + ArabCharUtil.KASRA + root!!.c3 + suffix
    }
}