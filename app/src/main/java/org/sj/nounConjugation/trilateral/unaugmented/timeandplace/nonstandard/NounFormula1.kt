 ...
 * @version 1.0
 */
class NounFormula1 : NonStandardTimeAndPlaceNounFormula {
    ...
    override fun form(): String {
        when (suffixNo) {
            1, 3, 7, 9, 13, 15 -> return ArabCharUtil.MEEM + ArabCharUtil.FATHA + root!!.c1 + ArabCharUtil.SKOON + root!!.c2 + ArabCharUtil.FATHA + root!!.c3 + suffix
        }
        return ""
    }
