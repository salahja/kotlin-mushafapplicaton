 ...
 * @version 1.0
 */
class NounFormula11 : NonStandardInstrumentalNounFormula {
    ...
    override fun form(): String {
        return if (suffixNo % 2 == 0) root.c1.toString() + ArabCharUtil.FATHA + root.c2 + ArabCharUtil.FATHA + root.c3 + suffix else ""
    }
