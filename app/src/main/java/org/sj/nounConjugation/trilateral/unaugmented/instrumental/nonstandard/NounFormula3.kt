 ...
 * @version 1.0
 */
class NounFormula3 : NonStandardInstrumentalNounFormula {
    ...
    override fun form(): String {
        when (suffixNo) {
            2, 4, 8, 10, 14, 16 -> return root.c1.toString() + ArabCharUtil.FATHA + ArabCharUtil.Aleph + root.c2 + ArabCharUtil.KASRA + root.c3 + suffix
        }
        return ""
    }
