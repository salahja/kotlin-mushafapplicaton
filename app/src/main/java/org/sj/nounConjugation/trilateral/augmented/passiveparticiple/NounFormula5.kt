 ...
 * @version 1.0
 */
class NounFormula5(root:AugmentedTrilateralRoot, suffix: String?) :
    ...
    override fun form(): String {
        return ArabCharUtil.MEEM + ArabCharUtil.DAMMA + root!!.c1 + ArabCharUtil.SKOON + ArabCharUtil.TA + ArabCharUtil.FATHA + root!!.c2 + ArabCharUtil.FATHA + root!!.c3 + suffix
    }
}