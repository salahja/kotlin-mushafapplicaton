 ...
 * @version 1.0
 */
class NounFormula15 : NonStandardInstrumentalNounFormula {
    ...
    override fun form(): String {
        return if (suffixNo % 2 == 0) ArabCharUtil.MEEM + ArabCharUtil.DAMMA + root.c1 + ArabCharUtil.FATHA + root.c2 + ArabCharUtil.SHADDA + ArabCharUtil.KASRA + root.c3 + suffix else ""
    }
