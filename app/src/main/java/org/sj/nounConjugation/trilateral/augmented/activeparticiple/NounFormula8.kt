...
class NounFormula8(root:AugmentedTrilateralRoot, suffix: String?) :
    ...
    override fun form(): String {
        return ArabCharUtil.MEEM + ArabCharUtil.DAMMA + ArabCharUtil.TA + ArabCharUtil.FATHA + root!!.c1 + ArabCharUtil.FATHA + root!!.c2 + ArabCharUtil.SHADDA + ArabCharUtil.KASRA + root!!.c3 + suffix
    }
}