...
class ExpandableVerseViewModel(
    ...
    private fun setNewNasb(
        ...
        val tagColorOne = if (thememode) Color(Constant.GREENDARK) else Color(ComposeConstant.KASHMIRIGREEN)
        val tagColorTwo = if (thememode) Color(Constant.BCYAN) else Color(Constant.prussianblue)
        val tagColorThree = if (thememode) Color(android.graphics.Color.YELLOW) else Color(Constant.deepburnsienna)
