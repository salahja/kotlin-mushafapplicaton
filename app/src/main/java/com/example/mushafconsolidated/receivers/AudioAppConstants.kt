...
open interface AudioAppConstants {
    ...
    open interface Paths {
        companion object {
            const val MAIN_DATABASE_PATH: String = "/quran_fekra_computers/quran.sqlite"
            const val TAFSEER_DATABASE_PATH: String = "/quran_fekra_computers/tafaseer"
    ...
    open interface MediaPlayer {
        companion object {
            const val INTENT: String = "NewShowMushafActivity"
            ...
            const val EVRYAYA: String = "evryayah"
            const val ONE_VERSE: String = "one_verse"
            const val FULLSURAPATH: String = "fullsurah"
