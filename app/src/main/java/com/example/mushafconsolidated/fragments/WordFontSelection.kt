...
class WordFontSelection constructor() : BottomSheetDialogFragment() {
    var mItemClickListener: OnItemClickListener? = null
    private var fontQuranAdapter: WordFontSelection.FontQuranAdapter? = null
...
//        radioGroup = view.findViewById(R.id.rdgroup)
    ...
    private inner class ViewHolder internal constructor(
        ...
        inflater.inflate(
            layout.word_font_selection, parent, false
        )
        ...
        init {
            ...
            rddejavufont = itemView.findViewById(R.id.rdquranic)
            ...
            rdqalam.setOnClickListener(object : View.OnClickListener {
                public override fun onClick(v: View?) {
                    ...
                    editor.putString("word_font_selection", "AlQalam.ttf")
                    editor.apply()
                    dismiss()
                }
            })
                ...
                public override fun onClick(v: View?) {
                    val editor: SharedPreferences.Editor =
                        android.preference.PreferenceManager.getDefaultSharedPreferences(activity)
                            .edit()
                    //     SharedPreferences.Editor editor = getActivity().getSharedPreferences("properties", 0).edit();
                    editor.putString("word_font_selection", "me_quran.ttf")
                    editor.apply()
                    dismiss()
                }
            })
            rddejavufont.setOnClickListener(object : View.OnClickListener {
                public override fun onClick(v: View?) {
                    val editor: SharedPreferences.Editor =
                        android.preference.PreferenceManager.getDefaultSharedPreferences(activity)
                            .edit()
                    //     SharedPreferences.Editor editor = getActivity().getSharedPreferences("properties", 0).edit();
                    editor.putString("word_font_selection", "DejaVuSans.ttf")
                    editor.apply()
                    dismiss()
                }
            })
    ...
    private inner class FontQuranAdapter internal constructor(private val mItemCount: String) :
        ...
        public override fun onBindViewHolder(
          holder: WordFontSelection.ViewHolder,
          position: Int
        ) {
            val sample: String = "بِسْمِ ٱللَّهِ ٱلرَّحْمَٰنِ ٱلرَّحِيمِ"
            ...
            val quran: Typeface = Typeface.createFromAsset(
                requireContext().assets, "DejaVuSans.ttf"
            )
    ...
    companion object {
        ...
        fun newInstance(): WordFontSelection {
            val fragment: WordFontSelection = WordFontSelection()
            return fragment
        }
    }
}