...
@AndroidEntryPoint
class GrammerFragmentsBottomSheetOrig : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(data: Array<String>): GrammerFragmentsBottomSheetOrig {
            val fragment = GrammerFragmentsBottomSheetOrig()
            val args = Bundle()
