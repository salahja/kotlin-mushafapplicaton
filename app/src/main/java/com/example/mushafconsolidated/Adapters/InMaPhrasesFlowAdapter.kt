...
class InMaPhrasesFlowAdapter(
    private var inMaNegationSentences: List<InMaListingPOJO>,
...
) : RecyclerView.Adapter<InMaPhrasesFlowAdapter.ItemViewAdapter>() //implements OnItemClickListenerOnLong {
{
    ...
    override fun getItemCount(): Int {
        return inMaNegationSentences.size + 1
        //     return  quran.size();
    }

    override fun getItemId(position: Int): Long {
        val sentence =inMaNegationSentences[position]
        var itemId: Long = 0
        return sentence.ayah.toLong()
    ...
    private fun displayAyats(
     ...
     //   var entity: QuranEntity? = null
        ...
        val entity = inMaNegationSentences[position]
