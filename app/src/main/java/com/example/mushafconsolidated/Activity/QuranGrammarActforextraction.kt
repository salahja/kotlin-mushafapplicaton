...
@AndroidEntryPoint
class QuranGrammarActforextraction : BaseActivity(), OnItemClickListenerOnLong {
...
private var preferences=""
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    this.shared = PreferenceManager.getDefaultSharedPreferences(this@QuranGrammarActforextraction)
...
*//*
  ...
  private fun initnavigation() {
    ...
    bottomNavigationView.setOnItemReselectedListener { item: MenuItem ->
      ...
      if (item.itemId == R.id.mushafview) {
        val settingints = Intent(this@QuranGrammarActforextraction, ShowMushafActivity::class.java)

        startActivity(settingints)
      }
      if (item.itemId == R.id.conjugationnav) {
        materialToolbar.title = "Conjugator"
        val conjugatorintent = Intent(this@QuranGrammarActforextraction, ConjugatorAct::class.java)
      ...
      if (item.itemId == R.id.names) {
        ...
        val settingint = Intent(this@QuranGrammarActforextraction, NamesGridImageAct::class.java)
      ...
      if (item.itemId == R.id.quiz) {
        ...
        val settingint = Intent(this@QuranGrammarActforextraction, ArabicVerbQuizActNew::class.java)
        settingint.putExtra(Constants.SURAH_INDEX, chapterno)
        startActivity(settingint)
    ...
    navigationView.setNavigationItemSelectedListener { item: MenuItem ->
      ...
      if (item.itemId == R.id.phrases) {
        ...
        val conjugatorintent =
          Intent(this@QuranGrammarActforextraction, MufradatPagerActivity::class.java)
        startActivity(conjugatorintent)
  ...
  private fun handleNavigation(selectedSurahIndex: Int) {
    ...
    if (myFragment != null && myFragment.isVisible) {
      val settingint = Intent(this, QuranGrammarActforextraction::class.java)
...
//                println(soraList[chapterno[0]].chapterid)
  ...
  private fun customizeDialogAppearance(alertDialog: AlertDialog) {
    ...
    buttonPositive.setTextColor(ContextCompat.getColor(this@QuranGrammarActforextraction, R.color.green))
    val buttonNegative = alertDialog.getButton(DialogInterface.BUTTON_NEGATIVE)
    buttonNegative.setTextColor(ContextCompat.getColor(this@QuranGrammarActforextraction, R.color.red))
    when (preferences) {
      "light", "brown" -> {
        buttonPositive.setTextColor(
          ContextCompat.getColor(
            this@QuranGrammarActforextraction, R.color.colorMuslimMate
          )
        )
        buttonNegative.setTextColor(
          ContextCompat.getColor(
            this@QuranGrammarActforextraction, R.color.red
          )
        )
      }
      ...
      "blue" -> {
        buttonPositive.setTextColor(
          ContextCompat.getColor(
            this@QuranGrammarActforextraction, R.color.yellow
          )
        )
        buttonNegative.setTextColor(
          ContextCompat.getColor(
            this@QuranGrammarActforextraction, R.color.Goldenrod
          )
        )
      }
      ...
      "green" -> {
        ...
        buttonNegative.setTextColor(
          ContextCompat.getColor(
            this@QuranGrammarActforextraction, R.color.cyan_light
          )
        )
      }
    }
        ...
        withContext(Dispatchers.Main) {
          ...
          val adapter =
            ...
            NewQuranDisplayAdapter(
              ...
              allofQuran,
              corpusGroupedByAyah,
              this@QuranGrammarActforextraction,
              surahArabicName,
              isMakkiMadani,
              listener,
              mainViewModel,
  ...
  override fun onItemClick(v: View, position: Int) {
    ...
    if (tag != null && tag.equals("header")) {
      // Handle header click
      Toast.makeText(this@QuranGrammarActforextraction, "Header clicked!", Toast.LENGTH_SHORT).show()
    } else {
        ...
        menuBuilder.setCallback(object : MenuBuilder.Callback {
          ...
          override fun onMenuItemSelected(menu: MenuBuilder, item: MenuItem): Boolean {
            if (item.itemId == R.id.actionTafsir) { // Handle option1 Click
              val readingintent =
                Intent(this@QuranGrammarActforextraction, TafsirFullscreenActivity::class.java)
            ...
            if (item.itemId == R.id.ivHelp) { // Handle option2 Click
              ParticleColorScheme.newInstance().show(
                this@QuranGrammarActforextraction.supportFragmentManager,
  ...
  private fun handleOverflowBottom(position: Int) {
    ...
    BottomOptionDialog.newInstance(data)
      .show(this@QuranGrammarActforextraction.supportFragmentManager, WordAnalysisBottomSheet.TAG)
  }
  ...
  private fun handleColorize(view: View) {
    ...
    if (colortag) {
      val editor =
        android.preference.PreferenceManager.getDefaultSharedPreferences(this@QuranGrammarActforextraction)
          .edit()
      //     SharedPreferences.Editor editor = getActivity().getSharedPreferences("properties", 0).edit();
      editor.putBoolean("colortag", false)
      editor.apply()
  ...
  fun qurangrammarmenus(view: View, position: Int) {
    ...
    if (tag == "arrowforward") {
      ...
      val readingintent = Intent(this@QuranGrammarActforextraction, TafsirFullscreenActivity::class.java)
