...
public final class FileAdapter extends RecyclerView.Adapter<FileAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        if (downloadData.eta == -1) {
            ...
            holder.timeRemainingTextView.setText(FUtils.getETAString(context, downloadData.eta));
        }

        if (downloadData.downloadedBytesPerSecond == 0) {
            holder.downloadedBytesPerSecondTextView.setText("");
        } else {
            holder.downloadedBytesPerSecondTextView.setText(FUtils.getDownloadSpeedString(context, downloadData.downloadedBytesPerSecond));
        }
